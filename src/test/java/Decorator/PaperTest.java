...
import ua.edu.ucu.apps.FlowerStoreWeb.flower.store.Decorators.Paper;
...
public class PaperTest {
    AbstractDecorator paper;
    Flower flower;

    @BeforeEach
    public void init() {
        flower = new Flower(1, 100, FlowerColor.BLUE, 100, FlowerType.TULIP);
        paper = new Paper(flower);
    }

    @Test
    void getPrice() {
        assertEquals(113, paper.getPrice());
    }

    @Test
    void getDetails() {
        assertEquals("Paper decorator", paper.getDescription());
    }
}
